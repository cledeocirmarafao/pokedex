...
export const ThemeToggle = () => {
    ...
    return (
        <button onClick={toggleTheme} aria-label="Toggle theme" className={`glass-card p-2 rounded-full transition-all duration-300 hover:scale-110 neon-glow cursor-pointer group ${theme === 'dark' ? 'hover:bg-black' : ''}`}>
            {theme === 'dark' ? (
